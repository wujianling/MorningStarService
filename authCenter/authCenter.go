...
import (
	...
	"MoringStarService/authCenter/internal/config"
	"MoringStarService/authCenter/internal/server"
...
var configFile = flag.String("f", "etc/authCenter.yaml", "the config file")
